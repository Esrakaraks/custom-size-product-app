...
const CustomSizeForm = ({ productId }) => {
  ...
  const SIZE_COEFFICIENTS = [
    { maxArea: 0.5, coefficient: 1 },
    { maxArea: 1, coefficient: 1.1 },
    { maxArea: 2, coefficient: 1.2 },
  ...
  React.useEffect(() => {
    if (boy && en && materyal) {
      ...
      if (Number.isNaN(boyNum) || Number.isNaN(enNum) || boyNum <= 0 || enNum <= 0) {
        setShowPrice(false);
        return;
      }
      const areaInMeters = boyNum * enNum / 1e4;
      const sizeCoeff = getSizeCoefficient(areaInMeters);
      const materialConfig = MATERIAL_PRICES[materyal];
      const basePricePerM2 = (materialConfig == null ? void 0 : materialConfig.basePrice) || 0;
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const contentType = createVariantResponse.headers.get("content-type") || "";
      if (!createVariantResponse.ok || !contentType.toLowerCase().includes("application/json")) {
      ...
      if (!variantData.success) {
        ...
        setMessage({
          type: "error",
          text: variantData.error || "The temporary product could not be created. Please try again or cancel."
        });
        setLoading(false);
        return;
      }
      ...
      const badge = document.querySelector("[data-cart-count]") || document.querySelector(".cart-count-bubble");
      if (badge) {
      ...
      setMessage({
        type: "success",
        text: `✅ Ürün sepete eklendi! (${boy}cm × ${en}cm - ${MATERIAL_PRICES[materyal].label})`
      });
      setTimeout(() => {
        setBoy("");
        setEn("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles.title, children: "Select Custom Size" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.formField, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: styles.label, children: "Height :" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.formField, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: styles.label, children: "Width :" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.formField, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: styles.label, children: "Materiel:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: "ahsap", children: [
              "Ahşap ($",
              MATERIAL_PRICES.ahsap.basePrice,
              "/m²)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: "metal", children: [
              "Metal ($",
              MATERIAL_PRICES.metal.basePrice,
              "/m²)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: "plastik", children: [
              "Plastik ($",
              MATERIAL_PRICES.plastik.basePrice,
              "/m²)"
            ] })
          ]
        }
    ...
    showPrice && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.priceBox, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.priceValue, children: [
      "$",
      calculatedPrice.toFixed(2)
    ] }) }),
    status === "creatingVariant" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.subtleStatus, children: "Creating temporary product, please wait..." }),
    status === "addingToCart" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.subtleStatus, children: "Adding product to cart, please wait..." }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: message.text }),
          status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.inlineButtons, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: loading ? "Processing..." : "Add to Cart"
      }
    )
  ] });
};
function initCustomSizeForm$1() {
  const rootElement = document.getElementById("custom-size-app-root");
  if (rootElement) {
    const productId = rootElement.dataset.productId;
    const root = ReactDOM.createRoot(rootElement);
    root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(CustomSizeForm, { productId }));
  }
}
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", initCustomSizeForm$1);
} else {
  initCustomSizeForm$1();
}
function initCustomSizeForm() {
  ...
  if (rootElement) {
    ...
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomSizeForm, { productId }) })
    );
  }
}
if (document.readyState === "loading") {
